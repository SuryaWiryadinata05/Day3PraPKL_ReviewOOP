...
<html lang="en">
  ...
  <body>
        ...
        <a class="navbar-brand" href="../tampilan/home.php">Home</a>

        <div class="collapse navbar-collapse" id="navbarTogglerDemo03">
            <ul class="navbar-nav mr-auto mt-2 mt-lg-0">
            <li class="nav-item active">
                <a class="nav-link" href="index.php">Jurusan <span class="sr-only">(current)</span></a>
            </li>
            <li class="nav-item">
                <a class="nav-link" href="../pendaftaran/index.php">Pendaftaran</a>
            </li>
            <li class="nav-item">
                <a class="nav-link" href="../pembayaran/index.php" tabindex="-1" aria-disabled="true">pembayaran</a>
            </li>
            </ul>
        ...
        <div class="abal pb-3 pt-5">
            <center><h2 style="color: white;">Jurusan</h2></center>
        </div>
        <div class="container">
        <div class="card bg-info " style = "margin-left: 19rem; margin-right: 19rem;">
            <div class="card-header bg-dark ">
                <h5 style="color: grey;">Data Jurusan</h5>
            </div>
            <div class="card-body">
            <?php
            ...
            <form action="" method="">
                ...
                <input type="hidden" name="no" value="<?php echo $no; ?>">
                    <div class="form-group bg-warning text-sm-center">
                        <label for="exampleInputEmail1 bg-light"><h5>nisss</h5></label> 
